...
<?php
    ...
    if (isset($_POST["email"]) && isset($_POST["password"])){
        ...
        $administradorNome = "Monte Nedro";
        $administradorEmail = "montenegro@mail.com";
        $senha = "griffon";

        if($_POST["email"] == $administradorEmail && $_POST["password"] == $senha){
            session_start();
            $_SESSION["administrador"] = $administradorNome;
        ...
        <?php
            ...
            if (isset($_SESSION["administrador"])) {
                ...
                echo "<h1>Logado com sucesso.</h1>
                      <h2> Bem-vindo, " . $_SESSION["administrador"] . "</h2>
                      <h4> Usuários: </h4>";
